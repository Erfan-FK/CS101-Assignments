...
{      
   public static void main(String[] args) {
      ...
      courseAndSemester = "CS101 Fall 2022";
      
      // Then print out welcome message for this course, semester and lab
      System.out.println( "Hi everyone, below are details about lab grades");
      System.out.println( "Welcome to " + courseAndSemester + " Lab 01" );
      System.out.println();
      
      // Now print out the grading policy
      System.out.println( "There will be "+ LABS_COUNT + " lab sessions in this course." );;;
